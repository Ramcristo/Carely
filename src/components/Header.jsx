...
import { assets, bannerData } from "../assets/assets";

const Header = () => {
  return (

    <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20">    {/* This line only gives a background color(div) if you don't know this please go through tailwind documentation*/}
