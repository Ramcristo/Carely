  ...
  const getAvailableStols = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endtime) {
        ...
        const isSlotAvailable = doctorinfo.slotsBooked[slotDate] && doctorinfo.slotsBooked[slotDate].includes(slotTime) ? false : true
      ...
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button
            ...
            className="bg-white text-primary text-sm font-semibold px-14 py-3 rounded-full my-6 border border-gray-200 hover:bg-primary hover:text-white transition-all duration-300"
          >
            Book An Appointment
          </button>
        </div>
